...
import '../test_doubles/fakes/fake_cart_item_repository.dart';

void main() {
  group('CartItemUseCase', () {
    test('addItem | valid item | item added', () async {
      // Arrange
      final repo = FakeCartItemRepository();
    ...
    test('getAll | repository throws | bubble exception', () async {
      // Arrange
      final repo = FakeCartItemRepository(fetchHandler: () async => throw Exception('db'));
      final useCase = CartItemUseCase(repo);
